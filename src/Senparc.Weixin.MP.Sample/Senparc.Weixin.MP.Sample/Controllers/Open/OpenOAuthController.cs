...
namespace Senparc.Weixin.MP.Sample.Controllers
{
    ...
    public class OpenOAuthController : BaseController
    {
        ...
        {
            //此页面引导用户点击授权
            ViewData["UrlUserInfo"] = Open.OAuthAPIs.OAuthApi.GetAuthorizeUrl(
                appId, 
                component_AppId,
                "http://senparcweixinmpsample.azurewebsites.net/OpenOAuth/UserInfoCallback",
                "JeffreySu",
                new[] { Open.OAuthScope.snsapi_userinfo, Open.OAuthScope.snsapi_base });
            ViewData["UrlBase"] = Open.OAuthAPIs.OAuthApi.GetAuthorizeUrl(appId, component_AppId, "http://senparcweixinmpsample.azurewebsites.net/OpenOAuth/BaseCallback", "JeffreySu", new[] { Open.OAuthScope.snsapi_userinfo, Open.OAuthScope.snsapi_base });
            return View();
        }
