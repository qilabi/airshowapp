...
namespace Senparc.Weixin.MP.Sample.RyanWebForms
{
    ...
    {
        public static readonly string Token = "TokenWeiXin";//与微信企业账号后台的Token设置保持一致，区分大小写。
        public static readonly string EncodingAESKey = "MibNU558c75elfAnVtfbDHnQ6s0OQlEXrwMCUm11Z73";//与微信企业账号后台的EncodingAESKey设置保持一致，区分大小写。
        public static readonly string CorpId = "gh_c910eda0c387";//与微信企业账号后台的EncodingAESKey设置保持一致，区分大小写。

        protected void Page_Load(object sender, EventArgs e)
        {
            string msg_signature = Request["signature"];//qy.aspx ;msg_signature
